...
def main():
    ...
    lbls = [ 'r4838 mean ped', 'r4838 mode ped' ]#, 'r4821 mean ped', 'r4821 mode ped' ]

    sipmDats = DB.DataSiPM(4821)
    noise_sampler = SiPMsNoiseSampler(4821)
